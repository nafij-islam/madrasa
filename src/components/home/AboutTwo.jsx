...
import dadatwo from "../../assets/Screenshot 2026-01-09 235238.png";
    ...
    <section className="py-6 md:py-20 bg-white">
      <Container>
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          {/* বাম পাশ: ছবি ও তথ্য (Profile Card) */}
          ...
          <div className="w-full lg:w-[65%] order-2 lg:order-2">
            <div className="space-y-6">
              ...
              <div className="text-gray-700 leading-relaxed text-justify space-y-4 text-base md:text-lg">
                ...
                <p>
                  बहुमुखि সঙ্কটে নিপতিত হয় ইসলামের লালনভূমি বাংলাদেশ। ক্রমেই হারাতে থাকে ইসলামী মূল্যবোধ ও ঐতিহ্য। হুমকির মুখে পড়ে মুসলিম উম্মাহর নতুন প্রজন্ম। ষাটের দশক। নুয়ে পড়া সে উম্মাহকে জাগিয়ে তুলতে ও স্থবির দেহে প্রাণ ফিরিয়ে আনতে নতুন করে কদম ফেলে আমাদের এই মিশন।
                </p>
                <p className="bg-[#E8F5E9] p-6 border-l-4 border-[#1F7A4D] italic rounded-r-xl">
              ...
              <div className="pt-4 flex justify-center lg:justify-end">
                <Link to={'/biography'}>
                  <button className="bg-[#1F7A4D] text-white px-10 py-4 rounded-full font-bold hover:bg-[#F4C430] hover:text-[#1F7A4D] transition-all shadow-lg active:scale-95">
                    বিস্তারিত জানুন
                  </button>
                </Link>
              </div>
